...
tablepath = 'C:\Users\emiramon\Documents\Data\Dataset 3\Start end points.csv'
...
for i = start_idx:end_idx 
    ...
    direction = false;
    if imcoords.y(idx) > pp(i) 
            y_high(j) = imcoords.y(idx);
            direction = true;
        elseif imcoords.y(idx) < pp(i)
            y_low(j) = imcoords.y(idx);
    end
